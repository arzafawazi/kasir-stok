...
?>
<!-- Sidebar -->
<ul class="navbar-nav  sidebar sidebar-dark accordion" style="background-color: #092635;" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">Toko Arza<sup></sup></div>
    </a>
