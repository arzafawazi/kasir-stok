...
class view
{
    ...
    public function nama_barang_row()
    {
        $sql = "select*from barang";
        $row = $this-> db -> prepare($sql);
        $row -> execute();
...
{
    $sql = "
        SELECT nota.*, barang.id_barang, barang.nama_barang, barang.harga_beli,
               member.id_member, member.nm_member,
               pelanggan.id_pelanggan, pelanggan.namapelanggan
        FROM nota
    ...
    public function nota() {
        $sql = "
            SELECT 
                ...
                b.namapelanggan
            FROM nota s
            INNER JOIN pelanggan b ON b.id_pelanggan = s.id_pelanggan
            ORDER BY s.id_pelanggan
        ";
