...
<div class="row">
    <div class="col-sm-4">
        <div class="card card-primary mb-3">
            <div class="card-header text-white" style="background-color: #40A2D8;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control" name="id_pelanggan">
                                            <?php foreach($hasil as $row_pelanggan) { ?>
                                            <option value="<?php echo $row_pelanggan['id_pelanggan']; ?>">
